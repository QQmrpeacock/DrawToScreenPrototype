using DrawToScreenPrototype.Modules.ModuleName.ViewModels;
using DrawToScreenPrototype.Services.Interfaces;
using Moq;
using Prism.Regions;
using Xunit;

namespace DrawToScreenPrototype.Modules.ModuleName.Tests.ViewModels
{
    public class SimpleCanvasView
    {
        ...
        {
            var vm = new SimpleCanvasViewModel(_regionManagerMock.Object, _messageServiceMock.Object);
